            ...
            for(int y = 0; y < height; y++)
            {
                ...
                { 
                    ...
                    for (int i = 0; lookupTriangulation(cubeIndex, i) != -1; i += 3)
                    {
                        ...
                        triangleCounter.Increment();
                        int ct = triangleCounter.Count - 1;
                        ...
                        vertices[ct*3 + 0] = new Vert() { vert = vertexOnEdge1, normal = normalOnPtOnEdge1 };
                        vertices[ct*3 + 1] = new Vert() { vert = vertexOnEdge2, normal = normalOnPtOnEdge2 };
                        vertices[ct*3 + 2] = new Vert() { vert = vertexOnEdge3, normal = normalOnPtOnEdge3 };  
                        triangleIndices[ct *3  + 0] = (uint)ct *3  + 0;  
                        triangleIndices[ct *3  + 1] = (uint)ct *3  + 1;  
                        triangleIndices[ct *3  + 2] = (uint)ct *3  + 2;
                    }
                }
            }
        }
